...
{
	in_context->ex_card(itmp1, itmp2, itmp3, itmp4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6);
}
...
{
	in_context->rp_card(itmp1, n_theta, n_phi, itmp4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6);
}
